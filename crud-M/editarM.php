...
if (isset($_GET['Id_Matricula'])) {
    ...
    $row = get_data($conexion, "SELECT m.*, 
                            ...
                            LEFT JOIN acudiente a ON m.Id_Acudiente = a.Id_Acudiente 
                            LEFT JOIN estudiante e ON m.Id_Estudiante = e.Id_Estudiante 
                            WHERE m.Id_Matricula =?", 'i', $Id_Matricula);
    ...
    echo "ID de matricula no proporcionado.";
    exit;
}
?>
...
<body>
    <div class="container">
        ...
        <form class="form-horizontal" method="POST" action="updateM.php" autocomplete="off">
            <input type="hidden" name="Id_Matricula" value="<?php echo $row['Id_Matricula']; ?>">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <center><a href="matricula.php" class="btn-default">Regresar</a>
