...
if (isset($_POST['submit'])) {
    ...
    $consultaSQL = "SELECT 
      ...
      INNER JOIN Acudiente a ON p.Id_Acudiente = a.Id_Acudiente
...
$sentencia->execute();
$pension = $sentencia->fetchAll();
?>

<div class="container">
  <div class="row">
    <div class="col-md-12">
    <center><h2 class="mt-3">Lista de Pensiones</h2></center>
    <br>
    <div class="boton">
      <a href="crearP.php">Crear</a>
    </div>
...
<div class="container">
  <div class="row">
    ...
    <tr>
        ...
        <td><a class="bt-editar" href="<?= 'editarP.php?Id_Pension=' . ($fila["Id_Pension"]) ?>">Editar</a></td>
    </tr>
<?php
}
?>
